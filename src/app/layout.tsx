...
export const metadata: Metadata = {
  title: "ABHEDYA AI — Sovereign AI Workbench for Confidential Industrial Intelligence",
  description:
  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        {/* DNS prefetch speeds up the Google Fonts lookup before preconnect kicks in */}
